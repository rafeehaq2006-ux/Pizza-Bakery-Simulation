...
public class SpiceShop extends Producer implements Tickable{
    public SpiceShop(String name){
        super(name,ResourceType.SPICEMIX,1);
    ...
    public void produce(Context ctx){
        ctx.state().addResource(ResourceType.SPICEMIX, this.amount);
    }
