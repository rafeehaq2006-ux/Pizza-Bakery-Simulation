...
public class TomatoFarm extends Producer implements Tickable{
    public TomatoFarm(String name){
        super(name,ResourceType.TOMATOES,5);
    ...
    public void produce(Context ctx){
        ctx.state().addResource(ResourceType.TOMATOES, this.amount);
    }
